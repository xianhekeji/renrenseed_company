...
//itemNew.js
var url_crop = getApp().globalData.constUrl + "wxCompanyApi/getCommodityByEnterpriseId.php";
var data;
var list = [];
var new_list = [];
...
var GetPinpaiData = function (that) {
  wx.request({
    ...
    //method: "POST",
    data: {
      companyid: companyUser.company.EnterpriseId
    },
    header: {
...
var GetList = function (that) {
  ...
  wx.request({
    ...
    data: {
      ...
      enid: companyUser.company.EnterpriseId,
...
Page({
  ...
  onclickList: function (event) {
    ...
    console.log(p);
    wx.navigateTo({ url: '/pages/commodityinfo/commodityinfo?id=' + p })
  },
